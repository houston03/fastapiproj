...
Revision ID: f17be03ff900
Revises:
Create Date: 2024-12-16 10:09:41.657016
...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_articles_article_id"), "articles", ["article_id"], unique=False
    )
    ...
    op.create_index(
        "ix_articles_tsv_content", "articles", ["tsv_content"], postgresql_using="gin"
    )
